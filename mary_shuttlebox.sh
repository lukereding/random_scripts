...
ffmpeg -i empty_shoal_6_use_this.mov -vcodec libx264 -r 30 -vf scale=960:544 -pix_fmt yuv420p -y empty.mp4 &
...
ffmpeg -ss 00:00:00 -t 00:00:21 -i empty_looped.mp4 -y empty_21_s.mp4 &
